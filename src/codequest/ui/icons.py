...
ICONS: dict[str, str] = {
    ...
    "mode.true_false": "mdi6.thumbs-up-down-outline",
    ...
    "completion.class": "mdi6.cube-outline",
    "completion.constant": "mdi6.format-list-bulleted-square",
    "completion.keyword": "mdi6.code-braces",
    "completion.text": "mdi6.text-short",
